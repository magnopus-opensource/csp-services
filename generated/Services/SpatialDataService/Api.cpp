...
namespace csp::services::generated::spatialdataservice {
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/anchors/{id}").c_str(),
                    {id}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AnchorsApi::anchorsIdDelete(
                const utility::string_t& id,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/anchors").c_str(),
                    {}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AnchorsApi::anchorResolutionsPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AnchorsApi::anchorResolutionsGet(
                const std::optional<std::vector<utility::string_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AnchorsApi::anchorResolutionsStatsGet(
                const std::optional<std::vector<utility::string_t>>&
                AnchorIds,const std::optional<std::vector<utility::string_t>>&
                Tags,const std::optional<bool>&
                TagsAll,const std::optional<bool>&
    ...
    PersonalPointOfInterestApi::PersonalPointOfInterestApi(csp::web::WebClient* InWebClient) : ApiBase(InWebClient, csp::CSPFoundation::GetEndpoints().SpatialDataService)
    {
    ...
    PersonalPointOfInterestApi::~PersonalPointOfInterestApi()
    {
            ...
            void PersonalPointOfInterestApi::usersUserIdPoiGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PersonalPointOfInterestApi::usersUserIdPoiPoiIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PersonalPointOfInterestApi::usersUserIdPoiPoiIdDelete(
                const utility::string_t& userId,const utility::string_t& poiId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
    ...
    PointOfInterestApi::~PointOfInterestApi()
    {
            ...
            void PointOfInterestApi::poiIdGet(
                const utility::string_t& id,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/poi/{id}").c_str(),
                    {id}
                );
            ...
            void PointOfInterestApi::poiIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PointOfInterestApi::poiIdDelete(
                const utility::string_t& id,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void PointOfInterestApi::poiLiteGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/poi-lite").c_str(),
                    {}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PointOfInterestApi::poiGet(
                const std::optional<utility::string_t>&
                ppoiUserId,const std::optional<std::vector<utility::string_t>>&
                Ids,const std::optional<utility::string_t>&
                Type,const std::optional<std::vector<utility::string_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/poi").c_str(),
                    {}
                );
            ...
            void PointOfInterestApi::poiPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PointOfInterestApi::poiDelete(
                const std::optional<std::vector<utility::string_t>>&
                ids,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            ...
            void PointOfInterestApi::poiIdPartialUpdatePut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PointOfInterestApi::poiTagsGet(
                const std::optional<utility::string_t>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/poi/tags").c_str(),
                    {}
                );
    ...
    PositionApi::~PositionApi()
    {
            ...
            void PositionApi::usersUserIdPositionsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PositionApi::usersUserIdPositionsPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PositionApi::usersPositionsLatestGet(
                const std::optional<std::vector<utility::string_t>>&
                UserIds,const std::optional<std::vector<utility::string_t>>&
                DeviceIds,const std::optional<std::vector<utility::string_t>>&
                PositionIds,const std::optional<utility::string_t>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PositionApi::usersUserIdPositionsLatestGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/positions/latest").c_str(),
                    {userId}
                );
            ...
            void PositionApi::usersUserIdPositionsPositionIdGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/positions/{positionId}").c_str(),
                    {userId,positionId}
                );
            ...
            void PositionApi::usersUserIdPositionsPositionIdDelete(
                const utility::string_t& userId,const utility::string_t& positionId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void PositionApi::groupsGroupIdPositionsLatestGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/positions/latest").c_str(),
                    {groupId}
                );
            ...
            void PositionApi::groupsPositionsLatestGet(
                const std::optional<std::vector<utility::string_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PositionApi::usersPositionsGet(
                const std::optional<std::vector<utility::string_t>>&
                userIds,const std::optional<std::vector<utility::string_t>>&
                UserIds,const std::optional<std::vector<utility::string_t>>&
                DeviceIds,const std::optional<std::vector<utility::string_t>>&
    ...
    PositionSpoofingApi::PositionSpoofingApi(csp::web::WebClient* InWebClient) : ApiBase(InWebClient, csp::CSPFoundation::GetEndpoints().SpatialDataService)
    {
    ...
    PositionSpoofingApi::~PositionSpoofingApi()
    {
            ...
            void PositionSpoofingApi::usersUserIdPositionsSpoofPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void PositionSpoofingApi::usersUserIdPositionsSpoofGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void PositionSpoofingApi::usersUserIdPositionsSpoofDelete(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void PositionSpoofingApi::positionsSpoofUsersGet(
                csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
    ...
    SpaceTimeApi::~SpaceTimeApi()
    {
            ...
            void SpaceTimeApi::usersUserIdSpacetimeIdGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SpaceTimeApi::usersUserIdSpacetimeIdDelete(
                const utility::string_t& userId,const utility::string_t& id,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void SpaceTimeApi::usersUserIdSpacetimeIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SpaceTimeApi::usersUserIdSpacetimePost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SpaceTimeApi::spacetimeGet(
                const std::optional<std::vector<utility::string_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/spacetime").c_str(),
                    {}
                );
