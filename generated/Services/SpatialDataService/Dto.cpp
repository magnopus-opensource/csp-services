...
namespace csp::services::generated::spatialdataservice
{
    ...
    utility::string_t AnchorDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value MgsIdValue(
                        TypeToJsonValue(m_MgsId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "mgsId",
                        MgsIdValue,
                ...
                {
                    rapidjson::Value ThirdPartyAnchorIdValue(
                        TypeToJsonValue(m_ThirdPartyAnchorId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "thirdPartyAnchorId",
                        ThirdPartyAnchorIdValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value ThirdPartyProviderNameValue(
                        TypeToJsonValue(m_ThirdPartyProviderName, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "thirdPartyProviderName",
                        ThirdPartyProviderNameValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value ReferenceIdValue(
                        TypeToJsonValue(m_ReferenceId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "referenceId",
                        ReferenceIdValue,
                ...
                {
                    rapidjson::Value AnchoredPrototypeIdValue(
                        TypeToJsonValue(m_AnchoredPrototypeId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "anchoredPrototypeId",
                        AnchoredPrototypeIdValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value AnchoredMultiplayerObjectIdValue(
                        TypeToJsonValue(m_AnchoredMultiplayerObjectId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "anchoredMultiplayerObjectId",
                        AnchoredMultiplayerObjectIdValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value SpatialKeyValueValue(
                        TypeToJsonValue(m_SpatialKeyValue, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "spatialKeyValue",
                        SpatialKeyValueValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                if (m_Position.has_value())
                {
                    rapidjson::Value PositionValue(
                        TypeToJsonValue(m_Position, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "position",
                        PositionValue,
                ...
                if (m_Rotation.has_value())
                {
                    rapidjson::Value RotationValue(
                        TypeToJsonValue(m_Rotation, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "rotation",
                        RotationValue,
        ...
        void AnchorDto::FromJson(const utility::string_t& Val)
        {
            ...
            void AnchorDto::SetThirdPartyAnchorId(
                    const utility::string_t& Value
                )
            {
            ...
            void AnchorDto::SetThirdPartyProviderName(
                    const utility::string_t& Value
                )
            {
            ...
            void AnchorDto::SetAnchoredPrototypeId(
                    const utility::string_t& Value
                )
            {
            ...
            const std::map<utility::string_t, utility::string_t>&
                    AnchorDto::GetSpatialKeyValue() const
            {
            ...
            void AnchorDto::SetSpatialKeyValue(
            ...
            void AnchorDto::SetLocation(
                    const std::shared_ptr<GeoCoord>& Value
                )
            {
                    m_Location = Value;
                }
            ...
            void AnchorDto::SetPosition(
                    const std::shared_ptr<AnchorPosition>& Value
                )
            {
                    m_Position = Value;
                }
            ...
            void AnchorDto::SetRotation(
                    const std::shared_ptr<AnchorRotation>& Value
                )
            {
                    m_Rotation = Value;
                }
    ...
    utility::string_t AnchorDtoDataPage::ToJson() const
        ...
        void AnchorDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<AnchorDto>>&
                    AnchorDtoDataPage::GetItems() const
            {
            ...
            void AnchorDtoDataPage::SetItems(
                    const std::vector<std::shared_ptr<AnchorDto>>& Value
                )
            {
                    m_Items = Value;
                }
    ...
    utility::string_t AnchorResolutionDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value AnchorIdValue(
                        TypeToJsonValue(m_AnchorId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "anchorId",
                        AnchorIdValue,
                ...
                {
                    rapidjson::Value SuccessfullyResolvedValue(
                        TypeToJsonValue(m_SuccessfullyResolved, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "successfullyResolved",
                        SuccessfullyResolvedValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value ResolveAttemptedValue(
                        TypeToJsonValue(m_ResolveAttempted, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "resolveAttempted",
                ...
                {
                    rapidjson::Value ResolveTimeValue(
                        TypeToJsonValue(m_ResolveTime, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "resolveTime",
                        ResolveTimeValue,
        ...
        void AnchorResolutionDto::FromJson(const utility::string_t& Val)
        {
            ...
            void AnchorResolutionDto::SetId(
                    const utility::string_t& Value
                )
            {
                    m_Id = Value;
            ...
            void AnchorResolutionDto::SetAnchorId(
                    const utility::string_t& Value
                )
            {
                    m_AnchorId = Value;
            ...
            void AnchorResolutionDto::SetSuccessfullyResolved(
                    const bool& Value
                )
            {
            ...
            const std::vector<utility::string_t>&
                    AnchorResolutionDto::GetTags() const
            {
                    return m_Tags.value();
                }
            ...
            void AnchorResolutionDto::SetTags(
                    const std::vector<utility::string_t>& Value
                )
            {
                    m_Tags = Value;
    ...
    utility::string_t AnchorResolutionDtoDataPage::ToJson() const
        ...
        void AnchorResolutionDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<AnchorResolutionDto>>&
                    AnchorResolutionDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            void AnchorResolutionDtoDataPage::SetItems(
                    const std::vector<std::shared_ptr<AnchorResolutionDto>>& Value
                )
            {
                    m_Items = Value;
                }
            ...
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                if (m_W.has_value())
                {
                    rapidjson::Value WValue(
                        TypeToJsonValue(m_W, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "w",
                        WValue,
    ...
    utility::string_t AnchorStatsDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value AverageResolveTimeValue(
                        TypeToJsonValue(m_AverageResolveTime, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "averageResolveTime",
                        AverageResolveTimeValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value AverageSuccessfullyResolvedValue(
                        TypeToJsonValue(m_AverageSuccessfullyResolved, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "averageSuccessfullyResolved",
                        AverageSuccessfullyResolvedValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value AverageResolveAttemptedValue(
                        TypeToJsonValue(m_AverageResolveAttempted, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "averageResolveAttempted",
                        AverageResolveAttemptedValue,
                        JsonDoc.GetAllocator()
                    );
                }
        ...
        void AnchorStatsDto::FromJson(const utility::string_t& Val)
        {
            ...
            void AnchorStatsDto::SetAnchorId(
                    const utility::string_t& Value
                )
            {
                    m_AnchorId = Value;
            ...
            void AnchorStatsDto::SetAverageResolveTime(double Value)
            {
                    m_AverageResolveTime = Value;
                }
            ...
            void AnchorStatsDto::SetAverageSuccessfullyResolved(double Value)
            {
                    m_AverageSuccessfullyResolved = Value;
                }
            ...
            void AnchorStatsDto::SetAverageResolveAttempted(double Value)
            {
                    m_AverageResolveAttempted = Value;
                }
    ...
    utility::string_t CalendarItemDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value EventStartValue(
                        TypeToJsonValue(m_EventStart, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "eventStart",
                        EventStartValue,
                ...
                {
                    rapidjson::Value EventEndValue(
                        TypeToJsonValue(m_EventEnd, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "eventEnd",
                        EventEndValue,
        ...
        void CalendarItemDto::FromJson(const utility::string_t& Val)
        {
            ...
            void CalendarItemDto::SetEventStart(
                    const utility::string_t& Value
                )
            {
                    m_EventStart = Value;
            ...
            void CalendarItemDto::SetEventEnd(
                    const utility::string_t& Value
                )
            {
                    m_EventEnd = Value;
    ...
    utility::string_t CalendarItemDtoArrayPartialUpdate::ToJson() const
        ...
        void CalendarItemDtoArrayPartialUpdate::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<CalendarItemDto>>&
                    CalendarItemDtoArrayPartialUpdate::GetValue() const
            {
            ...
            void CalendarItemDtoArrayPartialUpdate::SetValue(
                    const std::vector<std::shared_ptr<CalendarItemDto>>& Value
                )
            {
                    m_Value = Value;
                }
    ...
    utility::string_t GeoCoordArrayPartialUpdate::ToJson() const
        ...
        void GeoCoordArrayPartialUpdate::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<GeoCoord>>&
                    GeoCoordArrayPartialUpdate::GetValue() const
            {
                    return m_Value.value();
                }
            ...
            void GeoCoordArrayPartialUpdate::SetValue(
                    const std::vector<std::shared_ptr<GeoCoord>>& Value
                )
            {
                    m_Value = Value;
                }
    ...
    utility::string_t GeoCoordPartialUpdate::ToJson() const
        ...
        void GeoCoordPartialUpdate::FromJson(const utility::string_t& Val)
        {
            ...
            void GeoCoordPartialUpdate::SetValue(
                    const std::shared_ptr<GeoCoord>& Value
                )
            {
                    m_Value = Value;
    ...
    utility::string_t PersonalPointOfInterestDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value PoiIdValue(
                        TypeToJsonValue(m_PoiId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "poiId",
                        PoiIdValue,
        ...
        void PersonalPointOfInterestDto::FromJson(const utility::string_t& Val)
        {
            ...
            void PersonalPointOfInterestDto::SetUserId(
                    const utility::string_t& Value
                )
            {
                    m_UserId = Value;
            ...
            void PersonalPointOfInterestDto::SetPoiId(
                    const utility::string_t& Value
                )
            {
                    m_PoiId = Value;
    ...
    utility::string_t PoiPartialUpdate::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value GeofenceValue(
                        TypeToJsonValue(m_Geofence, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "geofence",
                        GeofenceValue,
                ...
                {
                    rapidjson::Value ScheduledEventsValue(
                        TypeToJsonValue(m_ScheduledEvents, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "scheduledEvents",
        ...
        void PoiPartialUpdate::FromJson(const utility::string_t& Val)
        {
            ...
            void PoiPartialUpdate::SetLocation(
                    const std::shared_ptr<GeoCoordPartialUpdate>& Value
                )
            {
                    m_Location = Value;
                }
            ...
            void PoiPartialUpdate::SetGeofence(
                    const std::shared_ptr<GeoCoordArrayPartialUpdate>& Value
                )
            {
                    m_Geofence = Value;
                }
            ...
            void PoiPartialUpdate::SetScheduledEvents(
                    const std::shared_ptr<CalendarItemDtoArrayPartialUpdate>& Value
                )
            {
    ...
    utility::string_t PointOfInterestDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value ZoomLevelValue(
                        TypeToJsonValue(m_ZoomLevel, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "zoomLevel",
                        ZoomLevelValue,
                ...
                {
                    rapidjson::Value ThumbnailUriValue(
                        TypeToJsonValue(m_ThumbnailUri, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "thumbnailUri",
                        ThumbnailUriValue,
                ...
                {
                    rapidjson::Value ThumbnailMimeTypeValue(
                        TypeToJsonValue(m_ThumbnailMimeType, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "thumbnailMimeType",
                        ThumbnailMimeTypeValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                if (m_Owner.has_value())
                {
                    rapidjson::Value OwnerValue(
                        TypeToJsonValue(m_Owner, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "owner",
                        OwnerValue,
                ...
                {
                    rapidjson::Value ScheduleValue(
                        TypeToJsonValue(m_Schedule, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "schedule",
                        ScheduleValue,
                ...
                {
                    rapidjson::Value GeneratedScheduleValue(
                        TypeToJsonValue(m_GeneratedSchedule, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "generatedSchedule",
                        GeneratedScheduleValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value EventIdValue(
                        TypeToJsonValue(m_EventId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "eventId",
                        EventIdValue,
                ...
                {
                    rapidjson::Value HiddenValue(
                        TypeToJsonValue(m_Hidden, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "hidden",
                        HiddenValue,
                ...
                {
                    rapidjson::Value PrivateValue(
                        TypeToJsonValue(m_Private, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "private",
                        PrivateValue,
                ...
                {
                    rapidjson::Value CmsIdValue(
                        TypeToJsonValue(m_CmsId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "cmsId",
                        CmsIdValue,
                ...
                {
                    rapidjson::Value PrototypeNameValue(
                        TypeToJsonValue(m_PrototypeName, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "prototypeName",
                        PrototypeNameValue,
                ...
                {
                    rapidjson::Value RequireActionValue(
                        TypeToJsonValue(m_RequireAction, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "requireAction",
                        RequireActionValue,
                ...
                {
                    rapidjson::Value IsDebugValue(
                        TypeToJsonValue(m_IsDebug, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "isDebug",
                        IsDebugValue,
                ...
                {
                    rapidjson::Value PrototypeTransformValue(
                        TypeToJsonValue(m_PrototypeTransform, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "prototypeTransform",
                        PrototypeTransformValue,
                        JsonDoc.GetAllocator()
                    );
                }
        ...
        void PointOfInterestDto::FromJson(const utility::string_t& Val)
        {
            ...
            void PointOfInterestDto::SetCreatedBy(
                    const utility::string_t& Value
                )
            {
                    m_CreatedBy = Value;
            ...
            void PointOfInterestDto::SetUpdatedBy(
                    const utility::string_t& Value
                )
            {
                    m_UpdatedBy = Value;
            ...
            void PointOfInterestDto::SetCreatedAt(
                    const utility::string_t& Value
                )
            {
                    m_CreatedAt = Value;
            ...
            void PointOfInterestDto::SetUpdatedAt(
                    const utility::string_t& Value
                )
            {
                    m_UpdatedAt = Value;
            ...
            const std::vector<std::shared_ptr<LocalizedString>>&
                    PointOfInterestDto::GetTitle() const
            {
            ...
            void PointOfInterestDto::SetTitle(
                    const std::vector<std::shared_ptr<LocalizedString>>& Value
                )
            {
                    m_Title = Value;
                }
            ...
            const std::vector<std::shared_ptr<LocalizedString>>&
                    PointOfInterestDto::GetDescription() const
            {
                    return m_Description.value();
                }
            ...
            void PointOfInterestDto::SetDescription(
                    const std::vector<std::shared_ptr<LocalizedString>>& Value
                )
            {
                    m_Description = Value;
            ...
            const std::map<utility::string_t, std::vector<std::shared_ptr<LocalizedString>>>&
                    PointOfInterestDto::GetUiStrings() const
            {
            ...
            void PointOfInterestDto::SetUiStrings(
            ...
            void PointOfInterestDto::SetType(
                    const utility::string_t& Value
                )
            {
                    m_Type = Value;
            ...
            const std::vector<utility::string_t>&
                    PointOfInterestDto::GetTags() const
            {
                    return m_Tags.value();
                }
            ...
            void PointOfInterestDto::SetTags(
                    const std::vector<utility::string_t>& Value
                )
            {
                    m_Tags = Value;
            ...
            void PointOfInterestDto::SetThumbnailUri(
                    const utility::string_t& Value
                )
            {
            ...
            void PointOfInterestDto::SetThumbnailMimeType(
                    const utility::string_t& Value
                )
            {
            ...
            void PointOfInterestDto::SetName(
                    const utility::string_t& Value
                )
            {
                    m_Name = Value;
            ...
            void PointOfInterestDto::SetOwner(
                    const utility::string_t& Value
                )
            {
                    m_Owner = Value;
            ...
            void PointOfInterestDto::SetLocation(
                    const std::shared_ptr<GeoCoord>& Value
                )
            {
                    m_Location = Value;
            ...
            const std::vector<std::shared_ptr<CalendarItemDto>>&
                    PointOfInterestDto::GetSchedule() const
            {
            ...
            void PointOfInterestDto::SetSchedule(
                    const std::vector<std::shared_ptr<CalendarItemDto>>& Value
                )
            {
                    m_Schedule = Value;
            ...
            const std::vector<std::shared_ptr<CalendarItemDto>>&
                    PointOfInterestDto::GetGeneratedSchedule() const
            {
            ...
            void PointOfInterestDto::SetGeneratedSchedule(
                    const std::vector<std::shared_ptr<CalendarItemDto>>& Value
                )
            {
                    m_GeneratedSchedule = Value;
                }
            ...
            void PointOfInterestDto::SetEventId(
                    const utility::string_t& Value
                )
            {
                    m_EventId = Value;
            ...
            void PointOfInterestDto::SetParentId(
                    const utility::string_t& Value
                )
            {
                    m_ParentId = Value;
            ...
            void PointOfInterestDto::SetGroupId(
                    const utility::string_t& Value
                )
            {
                    m_GroupId = Value;
            ...
            void PointOfInterestDto::SetHidden(
                    const bool& Value
                )
            {
                    m_Hidden = Value;
            ...
            const std::vector<std::shared_ptr<GeoCoord>>&
                    PointOfInterestDto::GetGeofence() const
            {
                    return m_Geofence.value();
                }
            ...
            void PointOfInterestDto::SetGeofence(
                    const std::vector<std::shared_ptr<GeoCoord>>& Value
                )
            {
                    m_Geofence = Value;
            ...
            void PointOfInterestDto::SetPrivate(
                    const bool& Value
                )
            {
                    m_Private = Value;
            ...
            void PointOfInterestDto::SetCmsId(
                    const utility::string_t& Value
                )
            {
                    m_CmsId = Value;
            ...
            void PointOfInterestDto::SetPrototypeId(
                    const utility::string_t& Value
                )
            {
                    m_PrototypeId = Value;
            ...
            void PointOfInterestDto::SetPrototypeName(
                    const utility::string_t& Value
                )
            {
            ...
            void PointOfInterestDto::SetRequireAction(
                    const bool& Value
                )
            {
            ...
            void PointOfInterestDto::SetIsDebug(
                    const bool& Value
                )
            {
                    m_IsDebug = Value;
            ...
            void PointOfInterestDto::SetPrototypeTransform(
    ...
    utility::string_t PointOfInterestDtoDataPage::ToJson() const
        ...
        void PointOfInterestDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<PointOfInterestDto>>&
                    PointOfInterestDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            void PointOfInterestDtoDataPage::SetItems(
                    const std::vector<std::shared_ptr<PointOfInterestDto>>& Value
                )
            {
                    m_Items = Value;
                }
    ...
    utility::string_t PointOfInterestLiteDto::ToJson() const
        ...
        void PointOfInterestLiteDto::FromJson(const utility::string_t& Val)
        {
            ...
            void PointOfInterestLiteDto::SetId(
                    const utility::string_t& Value
                )
            {
                    m_Id = Value;
            ...
            void PointOfInterestLiteDto::SetName(
                    const utility::string_t& Value
                )
            {
                    m_Name = Value;
            ...
            const std::vector<std::shared_ptr<LocalizedString>>&
                    PointOfInterestLiteDto::GetTitle() const
            {
                    return m_Title.value();
                }
            ...
            void PointOfInterestLiteDto::SetTitle(
                    const std::vector<std::shared_ptr<LocalizedString>>& Value
                )
            {
                    m_Title = Value;
            ...
            const std::vector<std::shared_ptr<LocalizedString>>&
                    PointOfInterestLiteDto::GetDescription() const
            {
                    return m_Description.value();
                }
            ...
            void PointOfInterestLiteDto::SetDescription(
                    const std::vector<std::shared_ptr<LocalizedString>>& Value
                )
            {
                    m_Description = Value;
            ...
            const std::map<utility::string_t, std::vector<std::shared_ptr<LocalizedString>>>&
                    PointOfInterestLiteDto::GetUiStrings() const
            {
                    return m_UiStrings.value();
                }
            ...
            void PointOfInterestLiteDto::SetUiStrings(
                    const std::map<utility::string_t, std::vector<std::shared_ptr<LocalizedString>>>& Value
                )
            {
                    m_UiStrings = Value;
            ...
            void PointOfInterestLiteDto::SetType(
                    const utility::string_t& Value
                )
            {
                    m_Type = Value;
            ...
            const std::vector<utility::string_t>&
                    PointOfInterestLiteDto::GetTags() const
            {
                    return m_Tags.value();
                }
            ...
            void PointOfInterestLiteDto::SetTags(
                    const std::vector<utility::string_t>& Value
                )
            {
                    m_Tags = Value;
            ...
            void PointOfInterestLiteDto::SetThumbnailUri(
                    const utility::string_t& Value
                )
            {
                    m_ThumbnailUri = Value;
            ...
            void PointOfInterestLiteDto::SetThumbnailMimeType(
                    const utility::string_t& Value
                )
            {
                    m_ThumbnailMimeType = Value;
            ...
            void PointOfInterestLiteDto::SetLocation(
                    const std::shared_ptr<GeoCoord>& Value
                )
            {
                    m_Location = Value;
            ...
            void PointOfInterestLiteDto::SetHidden(
                    const bool& Value
                )
            {
                    m_Hidden = Value;
            ...
            const std::vector<std::shared_ptr<GeoCoord>>&
                    PointOfInterestLiteDto::GetGeofence() const
            {
                    return m_Geofence.value();
                }
            ...
            void PointOfInterestLiteDto::SetGeofence(
                    const std::vector<std::shared_ptr<GeoCoord>>& Value
                )
            {
                    m_Geofence = Value;
            ...
            void PointOfInterestLiteDto::SetPrototypeName(
                    const utility::string_t& Value
                )
            {
                    m_PrototypeName = Value;
            ...
            void PointOfInterestLiteDto::SetPrototypeId(
                    const utility::string_t& Value
                )
            {
                    m_PrototypeId = Value;
    ...
    utility::string_t PointOfInterestLiteDtoDataPage::ToJson() const
        ...
        void PointOfInterestLiteDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<PointOfInterestLiteDto>>&
                    PointOfInterestLiteDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            void PointOfInterestLiteDtoDataPage::SetItems(
                    const std::vector<std::shared_ptr<PointOfInterestLiteDto>>& Value
                )
            {
                    m_Items = Value;
                }
    ...
    utility::string_t PositionDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value OffsiteValue(
                        TypeToJsonValue(m_Offsite, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "offsite",
                        OffsiteValue,
                ...
                {
                    rapidjson::Value GeofenceSearchRadiusValue(
                        TypeToJsonValue(m_GeofenceSearchRadius, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "geofenceSearchRadius",
                        GeofenceSearchRadiusValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value SpectatorValue(
                        TypeToJsonValue(m_Spectator, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "spectator",
                        SpectatorValue,
        ...
        void PositionDto::FromJson(const utility::string_t& Val)
        {
            ...
            void PositionDto::SetGeofenceSearchRadius(double Value)
            {
                    m_GeofenceSearchRadius = Value;
                }
    ...
    utility::string_t PositionDtoDataPage::ToJson() const
        ...
        void PositionDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<PositionDto>>&
                    PositionDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            void PositionDtoDataPage::SetItems(
                    const std::vector<std::shared_ptr<PositionDto>>& Value
                )
            {
                    m_Items = Value;
                }
    ...
    utility::string_t SpaceTimeDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value SpaceTimeTypeValue(
                        TypeToJsonValue(m_SpaceTimeType, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "spaceTimeType",
                        SpaceTimeTypeValue,
        ...
        void SpaceTimeDto::FromJson(const utility::string_t& Val)
        {
            ...
            void SpaceTimeDto::SetCreatedAt(
                    const utility::string_t& Value
                )
            {
                    m_CreatedAt = Value;
            ...
            void SpaceTimeDto::SetSpaceTimeType(
                    const std::shared_ptr<SpaceTimeType>& Value
                )
            {
            ...
            void SpaceTimeDto::SetPrototypeId(
                    const utility::string_t& Value
                )
            {
                    m_PrototypeId = Value;
    ...
    utility::string_t SpaceTimeDtoDataPage::ToJson() const
        ...
        void SpaceTimeDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<SpaceTimeDto>>&
                    SpaceTimeDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            void SpaceTimeDtoDataPage::SetItems(
                    const std::vector<std::shared_ptr<SpaceTimeDto>>& Value
                )
            {
                    m_Items = Value;
                }
    ...
    utility::string_t Transform::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value TranslationValue(
                        TypeToJsonValue(m_Translation, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "translation",
                        TranslationValue,
        ...
        void Transform::FromJson(const utility::string_t& Val)
        {
            ...
            void Transform::SetScale(
                    const std::shared_ptr<Scale>& Value
                )
            {
                    m_Scale = Value;
                }
            ...
            void Transform::SetTranslation(
                    const std::shared_ptr<Translation>& Value
                )
            {
                    m_Translation = Value;
                }
            ...
            void Transform::SetRotation(
                    const std::shared_ptr<Rotation>& Value
                )
            {
                    m_Rotation = Value;
                }
