...
namespace csp::services::generated::multiplayerservice {
    ...
    AreaOfInterestApi::~AreaOfInterestApi()
    {
            ...
            void AreaOfInterestApi::areaOfInterestUserIdResetPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/area-of-interest/{userId}/reset").c_str(),
                    {userId}
                );
            ...
            void AreaOfInterestApi::areaOfInterestUserIdGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
    ...
    ClientConnectionApi::ClientConnectionApi(csp::web::WebClient* InWebClient) : ApiBase(InWebClient, csp::CSPFoundation::GetEndpoints().MultiplayerService)
    {
    ...
    ClientConnectionApi::~ClientConnectionApi()
    {
            ...
            void ClientConnectionApi::clientConnectionsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ClientConnectionApi::clientConnectionsRequestToDisconnectPost(
                const std::optional<std::vector<utility::string_t>>&
                UserIds,const std::optional<std::vector<utility::string_t>>&
                ScopeIds,const std::optional<std::vector<utility::string_t>>&
                Scopes,const std::optional<std::vector<utility::string_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/client-connections/request-to-disconnect").c_str(),
                    {}
                );
    ...
    EventMessageApi::~EventMessageApi()
    {
            ...
            void EventMessageApi::eventsPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/events").c_str(),
                    {}
                );
    ...
    ObjectMessageApi::~ObjectMessageApi()
    {
            ...
            void ObjectMessageApi::objectsPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/objects").c_str(),
                    {}
                );
            ...
            void ObjectMessageApi::objectsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ObjectMessageApi::objectsDelete(
                const std::optional<std::vector<int32_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ObjectMessageApi::objectsBatchPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/objects/batch").c_str(),
                    {}
                );
            ...
            void ObjectMessageApi::objectsOwnersUserIdBatchPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ObjectMessageApi::objectsExportExportIdPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ObjectMessageApi::objectsImportExportIdPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ObjectMessageApi::objectsIdGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/objects/{id}").c_str(),
            ...
            void ObjectMessageApi::objectsIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ObjectMessageApi::objectsIdDelete(
                const int32_t& id,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void ObjectMessageApi::objectsIdPartialUpdatePut(
    ...
    ScopeLeaderApi::~ScopeLeaderApi()
    {
            ...
            void ScopeLeaderApi::scopesScopeIdLeaderGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ScopeLeaderApi::scopesScopeIdLeaderElectionPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/scopes/{scopeId}/leader-election").c_str(),
                    {scopeId}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/scopes").c_str(),
                    {}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/scopes/{id}").c_str(),
                    {id}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/scopes/referenceType/{referenceType}/referenceId/{referenceId}").c_str(),
