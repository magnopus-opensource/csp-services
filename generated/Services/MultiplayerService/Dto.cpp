...
namespace csp::services::generated::multiplayerservice
{
    ...
    utility::string_t AreaOfInterestDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value IsListeningValue(
                        TypeToJsonValue(m_IsListening, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "isListening",
                        IsListeningValue,
                ...
                {
                    rapidjson::Value IsSpectatorValue(
                        TypeToJsonValue(m_IsSpectator, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "isSpectator",
                        IsSpectatorValue,
                ...
                {
                    rapidjson::Value LastSolveTimeValue(
                        TypeToJsonValue(m_LastSolveTime, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "lastSolveTime",
                        LastSolveTimeValue,
                ...
                {
                    rapidjson::Value GlobalScopesValue(
                        TypeToJsonValue(m_GlobalScopes, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "globalScopes",
                        GlobalScopesValue,
                ...
                {
                    rapidjson::Value ObjectScopesValue(
                        TypeToJsonValue(m_ObjectScopes, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "objectScopes",
                        ObjectScopesValue,
                ...
                {
                    rapidjson::Value ObjectIdsValue(
                        TypeToJsonValue(m_ObjectIds, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "objectIds",
                        ObjectIdsValue,
                ...
                {
                    rapidjson::Value EntourageValue(
                        TypeToJsonValue(m_Entourage, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "entourage",
                        EntourageValue,
        ...
        void AreaOfInterestDto::FromJson(const utility::string_t& Val)
        {
            ...
            }void AreaOfInterestDto::SetPosition(
            ...
            const std::vector<utility::string_t>&
                    AreaOfInterestDto::GetGlobalScopes() const
            {
            ...
            const std::vector<utility::string_t>&
                    AreaOfInterestDto::GetObjectScopes() const
            {
            ...
            const std::vector<utility::string_t>&
                    AreaOfInterestDto::GetObjectIds() const
            {
            ...
            const std::vector<utility::string_t>&
                    AreaOfInterestDto::GetEntourage() const
            {
    ...
    utility::string_t BooleanUInt32NullableTuple::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value Item1Value(
                        TypeToJsonValue(m_Item1, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "item1",
                        Item1Value,
                ...
                {
                    rapidjson::Value Item2Value(
                        TypeToJsonValue(m_Item2, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "item2",
                        Item2Value,
        ...
        void BooleanUInt32NullableTuple::FromJson(const utility::string_t& Val)
        {
            ...
            }void BooleanUInt32NullableTuple::SetItem1(
                        const bool& Value
                    )
                {
                        m_Item1 = Value;
    ...
    utility::string_t ClientConnectionDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value ScopeIdsValue(
                        TypeToJsonValue(m_ScopeIds, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "scopeIds",
                        ScopeIdsValue,
                ...
                {
                    rapidjson::Value ConnectionStatusValue(
                        TypeToJsonValue(m_ConnectionStatus, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "connectionStatus",
        ...
        void ClientConnectionDto::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<utility::string_t>&
                    ClientConnectionDto::GetScopeIds() const
            {
            ...
            }void ClientConnectionDto::SetConnectionStatus(
                        const std::shared_ptr<ClientConnectionStatus>& Value
                    )
                {
    ...
    utility::string_t ClientConnectionDtoDataPage::ToJson() const
        ...
        void ClientConnectionDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<ClientConnectionDto>>&
                    ClientConnectionDtoDataPage::GetItems() const
            {
            ...
            }void ClientConnectionDtoDataPage::SetItems(
                        const std::vector<std::shared_ptr<ClientConnectionDto>>& Value
                    )
                {
                        m_Items = Value;
                    }
    ...
    utility::string_t EventMessageDto::ToJson() const
            ...
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                if (m_EventType.has_value())
                {
                    rapidjson::Value EventTypeValue(
                        TypeToJsonValue(m_EventType, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "eventType",
                        EventTypeValue,
                ...
                {
                    rapidjson::Value SenderUserIdValue(
                        TypeToJsonValue(m_SenderUserId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "senderUserId",
                        SenderUserIdValue,
                ...
                {
                    rapidjson::Value RecipientUserIdValue(
                        TypeToJsonValue(m_RecipientUserId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "recipientUserId",
                ...
                if (m_Components.has_value())
                {
                    rapidjson::Value ComponentsValue(
                        TypeToJsonValue(m_Components, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "components",
                        ComponentsValue,
        ...
        void EventMessageDto::FromJson(const utility::string_t& Val)
        {
            ...
            }void EventMessageDto::SetEventType(
            ...
            }void EventMessageDto::SetSenderUserId(
                        const utility::string_t& Value
                    )
                {
            ...
            }void EventMessageDto::SetRecipientUserId(
                        const utility::string_t& Value
                    )
                {
                        m_RecipientUserId = Value;
                    }
            const std::map<utility::string_t, std::shared_ptr<IComponentData>>&
                    EventMessageDto::GetComponents() const
            {
            ...
            }void EventMessageDto::SetComponents(
                        const std::map<utility::string_t, std::shared_ptr<IComponentData>>& Value
                    )
                {
                        m_Components = Value;
                    }
            const std::vector<utility::string_t>&
                    EventMessageDto::GetScopeIds() const
            {
                    return m_ScopeIds.value();
                }
            ...
            {
                return m_ScopeIds.has_value();
            }void EventMessageDto::SetScopeIds(
    ...
    utility::string_t ImportObjectMessageRequest::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value ScopeReferenceIdValue(
                        TypeToJsonValue(m_ScopeReferenceId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "scopeReferenceId",
                        ScopeReferenceIdValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value ScopeReferenceTypeValue(
                        TypeToJsonValue(m_ScopeReferenceType, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "scopeReferenceType",
                        ScopeReferenceTypeValue,
                        JsonDoc.GetAllocator()
                    );
                }
        ...
        void ImportObjectMessageRequest::FromJson(const utility::string_t& Val)
        {
            ...
            }void ImportObjectMessageRequest::SetScopeReferenceId(
                        const utility::string_t& Value
                    )
                {
            ...
            }void ImportObjectMessageRequest::SetScopeReferenceType(
                        const utility::string_t& Value
                    )
                {
    ...
    utility::string_t ObjectMessageDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value PrefabIdValue(
                        TypeToJsonValue(m_PrefabId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "prefabId",
                        PrefabIdValue,
                ...
                {
                    rapidjson::Value IsTransferableValue(
                        TypeToJsonValue(m_IsTransferable, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "isTransferable",
                        IsTransferableValue,
                ...
                {
                    rapidjson::Value IsPersistentValue(
                        TypeToJsonValue(m_IsPersistent, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "isPersistent",
                        IsPersistentValue,
                ...
                {
                    rapidjson::Value OwnerUserIdValue(
                        TypeToJsonValue(m_OwnerUserId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "ownerUserId",
                        OwnerUserIdValue,
                ...
                {
                    rapidjson::Value OnBehalfOfUserIdValue(
                        TypeToJsonValue(m_OnBehalfOfUserId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "onBehalfOfUserId",
                        OnBehalfOfUserIdValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value AoiCenterValue(
                        TypeToJsonValue(m_AoiCenter, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "aoiCenter",
                        AoiCenterValue,
                ...
                {
                    rapidjson::Value DuplicatedFromValue(
                        TypeToJsonValue(m_DuplicatedFrom, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "duplicatedFrom",
                        DuplicatedFromValue,
        ...
        void ObjectMessageDto::FromJson(const utility::string_t& Val)
        {
            ...
            }void ObjectMessageDto::SetIsTransferable(
                        const bool& Value
                    )
                {
            ...
            }void ObjectMessageDto::SetIsPersistent(
                        const bool& Value
                    )
                {
            ...
            }void ObjectMessageDto::SetOwnerUserId(
                        const utility::string_t& Value
                    )
                {
                        m_OwnerUserId = Value;
            ...
            {
                return m_ScopeReferenceId.has_value();
            }void ObjectMessageDto::SetScopeReferenceId(
                        const utility::string_t& Value
                    )
                {
                        m_ScopeReferenceId = Value;
            ...
            {
                return m_ScopeReferenceType.has_value();
            }void ObjectMessageDto::SetScopeReferenceType(
                        const utility::string_t& Value
                    )
                {
                        m_ScopeReferenceType = Value;
            ...
            }void ObjectMessageDto::SetOnBehalfOfUserId(
                        const utility::string_t& Value
                    )
                {
            ...
            const std::map<utility::string_t, std::shared_ptr<IComponentData>>&
                    ObjectMessageDto::GetComponents() const
            {
                    return m_Components.value();
                }
            ...
            {
                return m_Components.has_value();
            }void ObjectMessageDto::SetComponents(
                        const std::map<utility::string_t, std::shared_ptr<IComponentData>>& Value
                    )
                {
                        m_Components = Value;
            ...
            const std::vector<utility::string_t>&
                    ObjectMessageDto::GetScopeIds() const
            {
                    return m_ScopeIds.value();
                }
            ...
            {
                return m_ScopeIds.has_value();
            }void ObjectMessageDto::SetScopeIds(
                        const std::vector<utility::string_t>& Value
                    )
                {
                        m_ScopeIds = Value;
            ...
            }void ObjectMessageDto::SetAoiCenter(
                        const bool& Value
                    )
                {
                        m_AoiCenter = Value;
            ...
            }void ObjectMessageDto::SetDuplicatedFrom(
                        const utility::string_t& Value
                    )
                {
    ...
    utility::string_t ObjectMessageDtoDataPage::ToJson() const
        ...
        void ObjectMessageDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<ObjectMessageDto>>&
                    ObjectMessageDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            {
                return m_Items.has_value();
            }void ObjectMessageDtoDataPage::SetItems(
                        const std::vector<std::shared_ptr<ObjectMessageDto>>& Value
                    )
                {
                        m_Items = Value;
                    }
    ...
    utility::string_t ObjectMessagePatchDto::ToJson() const
        ...
        void ObjectMessagePatchDto::FromJson(const utility::string_t& Val)
        {
            ...
            {
                return m_OwnerUserId.has_value();
            }void ObjectMessagePatchDto::SetOwnerUserId(
                        const utility::string_t& Value
                    )
                {
                        m_OwnerUserId = Value;
            ...
            {
                return m_ParentId.has_value();
            }void ObjectMessagePatchDto::SetParentId(
                        const std::shared_ptr<BooleanUInt32NullableTuple>& Value
                    )
                {
                        m_ParentId = Value;
                    }
            const std::map<utility::string_t, std::shared_ptr<IComponentData>>&
                    ObjectMessagePatchDto::GetComponents() const
            {
                    return m_Components.value();
                }
            ...
            {
                return m_Components.has_value();
            }void ObjectMessagePatchDto::SetComponents(
                        const std::map<utility::string_t, std::shared_ptr<IComponentData>>& Value
                    )
                {
                        m_Components = Value;
    ...
    utility::string_t ScopeDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value ReferenceTypeValue(
                        TypeToJsonValue(m_ReferenceType, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "referenceType",
                        ReferenceTypeValue,
                ...
                {
                    rapidjson::Value PubSubModelValue(
                        TypeToJsonValue(m_PubSubModel, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "pubSubModel",
                        PubSubModelValue,
                ...
                {
                    rapidjson::Value SolveRadiusValue(
                        TypeToJsonValue(m_SolveRadius, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "solveRadius",
                        SolveRadiusValue,
                ...
                {
                    rapidjson::Value ManagedLeaderElectionValue(
                        TypeToJsonValue(m_ManagedLeaderElection, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "managedLeaderElection",
                        ManagedLeaderElectionValue,
                        JsonDoc.GetAllocator()
                    );
                }
        ...
        void ScopeDto::FromJson(const utility::string_t& Val)
        {
            ...
            }void ScopeDto::SetReferenceType(
                        const utility::string_t& Value
                    )
                {
            ...
            }void ScopeDto::SetPubSubModel(
                        const std::shared_ptr<PubSubModel>& Value
                    )
                {
                        m_PubSubModel = Value;
                    }
            ...
            }void ScopeDto::SetManagedLeaderElection(
                        const bool& Value
                    )
                {
    ...
    utility::string_t ScopeDtoDataPage::ToJson() const
        ...
        void ScopeDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<ScopeDto>>&
                    ScopeDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            {
                return m_Items.has_value();
            }void ScopeDtoDataPage::SetItems(
                        const std::vector<std::shared_ptr<ScopeDto>>& Value
                    )
                {
                        m_Items = Value;
                    }
    ...
    utility::string_t ScopeLeaderDto::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value ScopeIdValue(
                        TypeToJsonValue(m_ScopeId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "scopeId",
                        ScopeIdValue,
                ...
                {
                    rapidjson::Value LeaderUserIdValue(
                        TypeToJsonValue(m_LeaderUserId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "leaderUserId",
                        LeaderUserIdValue,
                ...
                {
                    rapidjson::Value ElectionInProgressValue(
                        TypeToJsonValue(m_ElectionInProgress, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "electionInProgress",
                        ElectionInProgressValue,
                        JsonDoc.GetAllocator()
                    );
                }
        ...
        void ScopeLeaderDto::FromJson(const utility::string_t& Val)
        {
            ...
            }void ScopeLeaderDto::SetScopeId(
                        const utility::string_t& Value
                    )
                {
                        m_ScopeId = Value;
            ...
            }void ScopeLeaderDto::SetLeaderUserId(
                        const utility::string_t& Value
                    )
                {
            ...
            }void ScopeLeaderDto::SetElectionInProgress(
                        const bool& Value
                    )
                {
