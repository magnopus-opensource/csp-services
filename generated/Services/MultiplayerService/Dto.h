    ...
    class AreaOfInterestDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                /// <summary>
                    /// Combined collection of Magnopus.Service.Multiplayer.Dtos.AreaOfInterestDto.GlobalScopes and Magnopus.Service.Multiplayer.Dtos.AreaOfInterestDto.ObjectScopes
                    /// </summary>
    ...
    class BooleanUInt32NullableTuple : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                bool GetItem1() const;
                void SetItem1(const bool& Value);bool HasItem1() const;
            
                int32_t GetItem2() const;
                void SetItem2(int32_t Value);bool HasItem2() const;
    ...
    class ClientConnectionDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetConnectionStatus(const std::shared_ptr<ClientConnectionStatus>& Value);bool HasConnectionStatus() const;
    ...
    class ClientConnectionDtoDataPage : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetItems(const std::vector<std::shared_ptr<ClientConnectionDto>>& Value);bool HasItems() const;
    ...
    class EventMessageDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetEventType(const utility::string_t& Value);bool HasEventType() const;
                ...
                void SetSenderUserId(const utility::string_t& Value);bool HasSenderUserId() const;
                ...
                void SetRecipientUserId(const utility::string_t& Value);bool HasRecipientUserId() const;
                ...
                void SetComponents(const std::map<utility::string_t, std::shared_ptr<IComponentData>>& Value);bool HasComponents() const;
                ...
                /// <summary>
                    ...
                    /// </summary>
                const std::vector<utility::string_t>& GetScopeIds() const;
                void SetScopeIds(const std::vector<utility::string_t>& Value);bool HasScopeIds() const;
    ...
    class ImportObjectMessageRequest : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetScopeReferenceId(const utility::string_t& Value);bool HasScopeReferenceId() const;
            
                /// <summary>
                    /// The type of reference the ScopeReferenceId is associated with
                    /// </summary>
                utility::string_t GetScopeReferenceType() const;
                void SetScopeReferenceType(const utility::string_t& Value);bool HasScopeReferenceType() const;
    ...
    class ObjectMessageDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetPrefabId(int32_t Value);bool HasPrefabId() const;
            
                /// <summary>
                    /// Can this object be transferred between owners
                    /// </summary>
                bool GetIsTransferable() const;
                void SetIsTransferable(const bool& Value);bool HasIsTransferable() const;
            
                /// <summary>
                    /// Is this a persistent object
                    /// </summary>
                bool GetIsPersistent() const;
                void SetIsPersistent(const bool& Value);bool HasIsPersistent() const;
                ...
                void SetOwnerUserId(const utility::string_t& Value);bool HasOwnerUserId() const;
                ...
                /// <summary>
                    ...
                    /// If set, this user will override Magnopus.Service.Multiplayer.Dtos.ObjectMessageDto.OwnerUserId for lookups of the assigned scopes and groups to propagate messages.
                    /// </summary>
                utility::string_t GetOnBehalfOfUserId() const;
                void SetOnBehalfOfUserId(const utility::string_t& Value);bool HasOnBehalfOfUserId() const;
            
                /// <summary>
                    /// ObjectId of the parent object this is linked to
                    /// </summary>
                int32_t GetParentId() const;
                void SetParentId(int32_t Value);bool HasParentId() const;
                ...
                void SetAoiCenter(const bool& Value);bool HasAoiCenter() const;
            
                /// <summary>
                    /// optional identifier used by the duplication process
                    /// </summary>
                utility::string_t GetDuplicatedFrom() const;
                void SetDuplicatedFrom(const utility::string_t& Value);bool HasDuplicatedFrom() const;
    ...
    class ObjectMessageDtoDataPage : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetItems(const std::vector<std::shared_ptr<ObjectMessageDto>>& Value);bool HasItems() const;
    ...
    class ObjectMessagePatchDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetParentId(const std::shared_ptr<BooleanUInt32NullableTuple>& Value);bool HasParentId() const;
    ...
    class ScopeDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetPubSubModel(const std::shared_ptr<PubSubModel>& Value);bool HasPubSubModel() const;
            
                /// <summary>
                    /// Solve radius for scope in meters, only useful on object scopes
                    /// </summary>
                double GetSolveRadius() const;
                void SetSolveRadius(double Value);bool HasSolveRadius() const;
            
                /// <summary>
                    /// Whether the scope requires a managed leader election
                    /// </summary>
                bool GetManagedLeaderElection() const;
                void SetManagedLeaderElection(const bool& Value);bool HasManagedLeaderElection() const;
    ...
    class ScopeDtoDataPage : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetItems(const std::vector<std::shared_ptr<ScopeDto>>& Value);bool HasItems() const;
    ...
    class ScopeLeaderDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetScopeId(const utility::string_t& Value);bool HasScopeId() const;
            
                /// <summary>
                    /// id of user who's connection is currently leader
                    /// </summary>
                utility::string_t GetLeaderUserId() const;
                void SetLeaderUserId(const utility::string_t& Value);bool HasLeaderUserId() const;
            
                /// <summary>
                    /// Set to true while an election is being actively managed
                    /// </summary>
                bool GetElectionInProgress() const;
                void SetElectionInProgress(const bool& Value);bool HasElectionInProgress() const;
