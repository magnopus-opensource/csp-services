    ...
    class ApplicationSettingsDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetAllowAnonymous(const bool& Value);bool HasAllowAnonymous() const;
    ...
    class GroupFilters : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetExcludeIds(const std::vector<utility::string_t>& Value);bool HasExcludeIds() const;
                ...
                void SetExcludedTags(const std::vector<utility::string_t>& Value);bool HasExcludedTags() const;
                ...
                void SetTagsAll(const bool& Value);bool HasTagsAll() const;
    ...
    class TenantCleanupFilters : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetDeleteTenant(const bool& Value);bool HasDeleteTenant() const;
            
                /// <summary>
                    /// Delete all the spaces under a tenant
                    /// </summary>
                bool GetDeleteAllSpaces() const;
                void SetDeleteAllSpaces(const bool& Value);bool HasDeleteAllSpaces() const;
            
                /// <summary>
                    /// Delete all the users under a tenant
                    /// </summary>
                bool GetDeleteAllUsers() const;
                void SetDeleteAllUsers(const bool& Value);bool HasDeleteAllUsers() const;
            
                /// <summary>
                    /// Delete all the poi data under a tenant
                    /// </summary>
                bool GetDeleteAllPois() const;
                void SetDeleteAllPois(const bool& Value);bool HasDeleteAllPois() const;
            
                /// <summary>
                    /// Delete all the sequences data under a tenant
                    /// </summary>
                bool GetDeleteAllSequences() const;
                void SetDeleteAllSequences(const bool& Value);bool HasDeleteAllSequences() const;
            
                /// <summary>
                    /// Delete all the encrypted data under a tenant
                    /// </summary>
                bool GetDeleteAllEncryptedDocuments() const;
                void SetDeleteAllEncryptedDocuments(const bool& Value);bool HasDeleteAllEncryptedDocuments() const;
            
                /// <summary>
                    /// Delete all the prototypes not associated with spaces
                    /// </summary>
                bool GetDeleteAllPrototypes() const;
                void SetDeleteAllPrototypes(const bool& Value);bool HasDeleteAllPrototypes() const;
    ...
    class TenantDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetAdminFullName(const utility::string_t& Value);bool HasAdminFullName() const;
            
                /// <summary>
                    /// The web URL for the tenant
                    /// </summary>
                utility::string_t GetCompanyWebUrl() const;
                void SetCompanyWebUrl(const utility::string_t& Value);bool HasCompanyWebUrl() const;
            
                /// <summary>
                    /// If the tenant hasn't verified their admin credentials
                    /// </summary>
                bool GetPendingAdmin() const;
                void SetPendingAdmin(const bool& Value);bool HasPendingAdmin() const;
    ...
    class UserQuery : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetPartialGuestDeviceId(const utility::string_t& Value);bool HasPartialGuestDeviceId() const;
                ...
                void SetSearchPartialEmails(const bool& Value);bool HasSearchPartialEmails() const;
                ...
                void SetGuestDeviceIds(const std::vector<utility::string_t>& Value);bool HasGuestDeviceIds() const;
            
                /// <summary>
                    /// Query on users EmailAddresses
                    /// </summary>
                const std::vector<utility::string_t>& GetEmailAddresses() const;
                void SetEmailAddresses(const std::vector<utility::string_t>& Value);bool HasEmailAddresses() const;
            
                /// <summary>
                    /// Query on users UserNames
                    /// </summary>
                const std::vector<utility::string_t>& GetUserNames() const;
                void SetUserNames(const std::vector<utility::string_t>& Value);bool HasUserNames() const;
            
                /// <summary>
                    /// Query on users LastDeviceIds
                    /// </summary>
                const std::vector<utility::string_t>& GetLastDeviceIds() const;
                void SetLastDeviceIds(const std::vector<utility::string_t>& Value);bool HasLastDeviceIds() const;
