...
namespace csp::services::generated::userservice {
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AuthenticationApi::apiV1UsersOnetimekeyPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/users/onetimekey",
                    {}
                );
            ...
            void AuthenticationApi::apiV1UsersKeyexchangePost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/users/keyexchange",
                    {}
                );
