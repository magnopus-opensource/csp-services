...
namespace csp::services::generated::userservice {
    ...
    ApplicationSettingsApi::ApplicationSettingsApi(csp::web::WebClient* InWebClient) : ApiBase(InWebClient, csp::CSPFoundation::GetEndpoints().UserService)
    {
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/applications/{applicationName}/settings/{context}").c_str(),
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ApplicationSettingsApi::tenantsTenantApplicationsApplicationNameSettingsContextGet(
                const utility::string_t& tenant,const utility::string_t& applicationName,const utility::string_t& context,const std::optional<std::vector<utility::string_t>>&
                keys,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/tenants/{tenant}/applications/{applicationName}/settings/{context}").c_str(),
            ...
            void ApplicationSettingsApi::applicationsApplicationNameSettingsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/applications/{applicationName}/settings").c_str(),
                    {applicationName}
                );
            ...
            void ApplicationSettingsApi::applicationsApplicationNameSettingsDelete(
                const utility::string_t& applicationName,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/applications/{applicationName}/settings/{context}/{keyname}").c_str(),
    ...
    AuthenticationApi::~AuthenticationApi()
    {
            ...
            void AuthenticationApi::usersLoginPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/login").c_str(),
                    {}
                );
            ...
            void AuthenticationApi::usersLoginSocialPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AuthenticationApi::socialProvidersProviderGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AuthenticationApi::usersLogoutPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/logout").c_str(),
                    {}
                );
            ...
            void AuthenticationApi::usersRefreshPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/refresh").c_str(),
                    {}
                );
    ...
    AvatarsApi::~AvatarsApi()
    {
            ...
            void AvatarsApi::usersUserIdAvatarsPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AvatarsApi::usersUserIdAvatarsAvatarIdGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/avatars/{avatarId}").c_str(),
                    {userId,avatarId}
                );
            ...
            void AvatarsApi::usersUserIdAvatarsAvatarIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void AvatarsApi::usersUserIdAvatarsAvatarIdDelete(
                const utility::string_t& userId,const utility::string_t& avatarId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void AvatarsApi::usersUserIdAvatarsAvatarIdExistsGet(
                const utility::string_t& userId,const utility::string_t& avatarId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/avatars/{avatarId}/exists").c_str(),
                    {userId,avatarId}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups").c_str(),
                    {}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void GroupApi::groupCodesGroupCodeUsersUserIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/group-codes/{groupCode}/users/{userId}").c_str(),
                    {groupCode,userId}
                );
            ...
            void GroupApi::groupsGroupIdGroupCodeResetPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/group-code-reset").c_str(),
                    {groupId}
                );
            ...
            void GroupApi::groupsGroupIdBannedUsersUserIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/banned-users/{userId}").c_str(),
                    {groupId,userId}
                );
            ...
            void GroupApi::groupsGroupIdBannedUsersUserIdDelete(
                const utility::string_t& groupId,const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void GroupApi::groupsGroupIdDelete(
                const utility::string_t& groupId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}").c_str(),
                    {groupId}
                );
            ...
            void GroupApi::groupsGroupIdGet(
                const utility::string_t& groupId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void GroupApi::usersUserIdGroupsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void GroupApi::groupsGroupIdUsersUserIdDelete(
                const utility::string_t& groupId,const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/users/{userId}").c_str(),
                    {groupId,userId}
                );
            ...
            void GroupApi::groupsSummariesGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups-summaries").c_str(),
                    {}
                );
            ...
            void GroupApi::groupsGroupIdEmailInvitesPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void GroupApi::groupsGroupIdEmailInvitesGet(
                const utility::string_t& groupId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void GroupApi::groupsGroupIdEmailInvitesBulkPost(
                const utility::string_t& groupId,const std::optional<bool>&
                resendInvite,const std::optional<utility::string_t>&
                emailLinkUrl,const std::optional<utility::string_t>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/email-invites/bulk").c_str(),
                    {groupId}
                );
            ...
            void GroupApi::groupsGroupIdLitePut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void GroupApi::groupsGroupIdLiteGet(
                const utility::string_t& groupId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void GroupApi::groupsGroupIdOwnerNewGroupOwnerIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/owner/{newGroupOwnerId}").c_str(),
            ...
            void GroupApi::groupsGroupIdEmailInvitesAcceptedGet(
                const utility::string_t& groupId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/email-invites/accepted").c_str(),
                    {groupId}
                );
            ...
            void GroupApi::groupsGroupIdEmailInvitesEmailInviteIdDelete(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/email-invites/{emailInviteId}").c_str(),
            ...
            void GroupApi::groupsGroupIdModeratorsUserIdPut(
                const utility::string_t& groupId,const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/moderators/{userId}").c_str(),
                    {groupId,userId}
                );
            ...
            void GroupApi::groupsGroupIdModeratorsUserIdDelete(
                const utility::string_t& groupId,const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void GroupApi::groupsLiteGet(
                ...
                ExcludeIds,const std::optional<std::vector<utility::string_t>>&
                Users,const std::optional<bool>&
                Discoverable,const std::optional<bool>&
                AutoModerator,const std::optional<bool>&
                RequiresInvite,const std::optional<bool>&
                Archived,const std::optional<std::vector<utility::string_t>>&
                OrganizationIds,const std::optional<std::vector<utility::string_t>>&
                Tags,const std::optional<std::vector<utility::string_t>>&
                ExcludedTags,const std::optional<bool>&
                TagsAll,const std::optional<int32_t>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/lite").c_str(),
                    {}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void GroupApi::groupsUsersUserIdEmailInvitesGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/users/{userId}/email-invites").c_str(),
                    {userId}
                );
            ...
            void GroupApi::groupsGroupIdUsersUserIdEmailInvitesEmailInviteIdAcceptPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/{groupId}/users/{userId}/email-invites/{emailInviteId}/accept").c_str(),
            ...
            void GroupApi::groupsArchivedPut(
                const utility::string_t& groupOwnerId,const std::optional<std::vector<utility::string_t>>&
                groupIds,const bool& archived,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/groups/archived").c_str(),
                    {}
                );
    ...
    InventoryApi::~InventoryApi()
    {
            ...
            void InventoryApi::usersUserIdInventoryItemsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void InventoryApi::usersUserIdInventoryItemsPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void InventoryApi::usersUserIdInventoryIdsGet(
                const utility::string_t& userId,const std::optional<std::vector<utility::string_t>>&
                Ids,const std::optional<std::vector<utility::string_t>>&
                PrototypeIds,const std::optional<bool>&
                Exchangeable,const std::optional<bool>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void InventoryApi::usersInventoryItemsOwnersGet(
                const std::optional<std::vector<utility::string_t>>&
                Ids,const std::optional<std::vector<utility::string_t>>&
                PrototypeIds,const std::optional<bool>&
                Exchangeable,const std::optional<bool>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void InventoryApi::usersInventoryCountGet(
                const std::optional<std::vector<utility::string_t>>&
                Ids,const std::optional<std::vector<utility::string_t>>&
                PrototypeIds,const std::optional<bool>&
                Exchangeable,const std::optional<bool>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void InventoryApi::usersUserIdInventoryItemsIdGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/inventory-items/{id}").c_str(),
                    {userId,id}
                );
            ...
            void InventoryApi::usersUserIdInventoryItemsIdDelete(
                const utility::string_t& userId,const utility::string_t& id,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void InventoryApi::usersUserIdInventoryItemsIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void InventoryApi::usersUserIdInventoryItemsIdEquipPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/inventory-items/{id}/equip").c_str(),
                    {userId,id}
                );
    ...
    OrganizationApi::~OrganizationApi()
    {
            ...
            void OrganizationApi::organizationsPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/organizations").c_str(),
                    {}
                );
            ...
            void OrganizationApi::organizationsOrganizationIdGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void OrganizationApi::organizationsOrganizationIdPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void OrganizationApi::organizationsOrganizationIdDelete(
                const utility::string_t& organizationId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void OrganizationApi::organizationsOrganizationIdMembershipInvitesPost(
                const utility::string_t& organizationId,const std::optional<bool>&
                resendInvite,const std::optional<utility::string_t>&
                emailLinkUrl,const std::optional<utility::string_t>&
                signupUrl,const std::shared_ptr<OrganizationInviteDto>& RequestBody,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/organizations/{organizationId}/membership-invites").c_str(),
                    {organizationId}
                );
            ...
            void OrganizationApi::organizationsOrganizationIdMembershipInvitesGet(
                const utility::string_t& organizationId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void OrganizationApi::organizationsOrganizationIdMembershipInvitesBulkPost(
                const utility::string_t& organizationId,const std::optional<bool>&
                resendInvite,const std::optional<utility::string_t>&
                emailLinkUrl,const std::optional<utility::string_t>&
                signupUrl,const std::vector<std::shared_ptr<OrganizationInviteDto>>& RequestBody,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/organizations/{organizationId}/membership-invites/bulk").c_str(),
                    {organizationId}
                );
            ...
            void OrganizationApi::organizationsOrganizationIdUsersUserIdDelete(
                const utility::string_t& organizationId,const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/organizations/{organizationId}/users/{userId}").c_str(),
            ...
            void OrganizationApi::organizationsOrganizationIdRolesGet(
                const utility::string_t& organizationId,const std::optional<std::vector<utility::string_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/organizations/{organizationId}/roles").c_str(),
                    {organizationId}
                );
            ...
            void OrganizationApi::organizationsOrganizationIdUsersUserIdRolesPut(
                const utility::string_t& organizationId,const utility::string_t& userId,const std::vector<utility::string_t>& RequestBody,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/organizations/{organizationId}/users/{userId}/roles").c_str(),
                    {organizationId,userId}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users").c_str(),
                    {}
                );
            ...
            void ProfileApi::usersGet(
                const std::optional<utility::string_t>&
                GuestDeviceId,const std::optional<utility::string_t>&
                PartialGuestDeviceId,const std::optional<utility::string_t>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ProfileApi::usersCreateSocialPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ProfileApi::usersUserIdUpgradeGuestPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ProfileApi::usersUserIdUpgradeGuestSocialPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/upgrade-guest-social").c_str(),
                    {userId}
                );
            ...
            void ProfileApi::usersUserIdDelete(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}").c_str(),
                    {userId}
                );
            ...
            void ProfileApi::usersUserIdGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void ProfileApi::usersUserIdHardDeleteDelete(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void ProfileApi::usersHardDeleteDelete(
                const std::optional<std::vector<utility::string_t>>&
                ids,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            ...
            void ProfileApi::usersProfileIdsPost(
                const std::optional<int32_t>&
                Skip,const std::optional<int32_t>&
                Limit,const std::shared_ptr<UserQuery>& RequestBody,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
            ...
            void ProfileApi::usersTenantsTenantProfileIdsPost(
                const utility::string_t& tenant,const std::optional<int32_t>&
                Skip,const std::optional<int32_t>&
                Limit,const std::shared_ptr<UserQuery>& RequestBody,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/tenants/{tenant}/profile-ids").c_str(),
                    {tenant}
                );
            ...
            void ProfileApi::usersUserIdTokenChangePasswordPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/token-change-password").c_str(),
                    {userId}
                );
            ...
            void ProfileApi::usersForgotPasswordPost(
                const std::optional<utility::string_t>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ProfileApi::usersUserIdConfirmEmailPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ProfileApi::usersEmailsEmailConfirmEmailReSendPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/emails/{email}/confirm-email/re-send").c_str(),
                    {email}
                );
            ...
            void ProfileApi::usersUserIdMetagamePut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ProfileApi::usersUserIdMetagameGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void ProfileApi::usersUserIdFirstNameFirstNamePut(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/first-name/{firstName}").c_str(),
                    {userId,firstName}
                );
            ...
            void ProfileApi::usersUserIdDisplayNamePut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ProfileApi::usersUserIdLiteGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/lite").c_str(),
                    {}
                );
            ...
            void ProfileApi::usersUserIdLockAccountPut(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void ProfileApi::usersUserIdUnlockAccountPut(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
    ...
    SettingsApi::~SettingsApi()
    {
            ...
            void SettingsApi::usersUserIdSettingsContextPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/settings/{context}").c_str(),
                    {userId,context}
                );
            ...
            void SettingsApi::usersUserIdSettingsContextGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SettingsApi::usersUserIdSettingsContextDelete(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SettingsApi::usersSettingsContextGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SettingsApi::usersUserIdSettingsGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void SettingsApi::usersUserIdSettingsContextKeynameDelete(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/users/{userId}/settings/{context}/{keyname}").c_str(),
    ...
    StripeApi::~StripeApi()
    {
            ...
            void StripeApi::vendorsStripeWebhookPost(
                const std::optional<utility::string_t>&
                tenant,const std::optional<utility::string_t>&
                environmentAlias,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
            ...
            void StripeApi::vendorsStripeCheckoutSessionsPost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/vendors/stripe/checkout-sessions").c_str(),
                    {}
                );
            ...
            void StripeApi::vendorsStripeCustomersUserIdGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/vendors/stripe/customers/{userId}").c_str(),
                    {userId}
                );
            ...
            void StripeApi::vendorsStripeCustomerPortalsUserIdGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/vendors/stripe/customer-portals/{userId}").c_str(),
                    {userId}
                );
    ...
    TenantApi::~TenantApi()
    {
            ...
            void TenantApi::tenantsNamesTenantNamePut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void TenantApi::tenantsNamesTenantNameGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void TenantApi::tenantsPendingDelete(
                const int32_t& tenantAgeInDays,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                        fmt::format("{0}/api/v{1}{2}", ServiceDefinition.GetURI().c_str(), ServiceDefinition.GetVersion(), "/tenants/pending").c_str(),
                    {}
                );
            ...
            void TenantApi::tenantsNamesNameDelete(
                const utility::string_t& name,const std::shared_ptr<TenantCleanupFilters>& RequestBody,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
    ...
    UserRolesApi::~UserRolesApi()
    {
            ...
            void UserRolesApi::usersUserIdRolesGet(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void UserRolesApi::usersUserIdRolesPut(
