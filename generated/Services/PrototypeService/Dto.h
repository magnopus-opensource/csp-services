    ...
    class ExportPrototypesResponse : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetPrototypes(const std::vector<std::shared_ptr<ExportedPrototypeDto>>& Value);bool HasPrototypes() const;
                ...
                void SetAssets(const std::vector<std::shared_ptr<ExportedAssetDetailDto>>& Value);bool HasAssets() const;
            
                /// <summary>
                    /// Reasons for failure
                    /// </summary>
                const std::vector<utility::string_t>& GetDenials() const;
                void SetDenials(const std::vector<utility::string_t>& Value);bool HasDenials() const;
    ...
    class InternalFileCopyRequest : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetSourceFileInfo(const std::shared_ptr<MusubiFileInfo>& Value);bool HasSourceFileInfo() const;
            
                std::shared_ptr<MusubiFileInfo> GetDestinationFileInfo() const;
                void SetDestinationFileInfo(const std::shared_ptr<MusubiFileInfo>& Value);bool HasDestinationFileInfo() const;
    ...
    class MusubiFileInfo : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetSource(const utility::string_t& Value);bool HasSource() const;
            
                std::shared_ptr<FileSource> GetFileSource() const;
                void SetFileSource(const std::shared_ptr<FileSource>& Value);bool HasFileSource() const;
            
                utility::string_t GetDirectory() const;
                void SetDirectory(const utility::string_t& Value);bool HasDirectory() const;
            
                utility::string_t GetFilename() const;
                void SetFilename(const utility::string_t& Value);bool HasFilename() const;
            
                utility::string_t GetExtension() const;
                void SetExtension(const utility::string_t& Value);bool HasExtension() const;
            
                utility::string_t GetBucket() const;
                void SetBucket(const utility::string_t& Value);bool HasBucket() const;
            
                utility::string_t GetBucketInfo() const;
                void SetBucketInfo(const utility::string_t& Value);bool HasBucketInfo() const;
            
                utility::string_t GetFullUrl() const;
                void SetFullUrl(const utility::string_t& Value);bool HasFullUrl() const;
