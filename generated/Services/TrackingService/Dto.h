    ...
    class QuotaFeatureActivityDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetFeatureName(const utility::string_t& Value);bool HasFeatureName() const;
            
                /// <summary>
                    /// The type of the entity(s) that the quota applies to (literal strings "user", etc)
                    /// </summary>
                utility::string_t GetAppliesToType() const;
                void SetAppliesToType(const utility::string_t& Value);bool HasAppliesToType() const;
            
                /// <summary>
                    /// The id of the entity(s) that the quota applies to (user id, etc)
                    /// </summary>
                utility::string_t GetAppliesToId() const;
                void SetAppliesToId(const utility::string_t& Value);bool HasAppliesToId() const;
                ...
                void SetAppliesToQualifierType(const utility::string_t& Value);bool HasAppliesToQualifierType() const;
                ...
                void SetAppliesToQualifierId(const utility::string_t& Value);bool HasAppliesToQualifierId() const;
                ...
                void SetAmount(int32_t Value);bool HasAmount() const;
    ...
    class QuotaFeatureActivityDtoDataPage : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetItems(const std::vector<std::shared_ptr<QuotaFeatureActivityDto>>& Value);bool HasItems() const;
    ...
    class QuotaFeatureLimitProgressDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetActivityCount(int32_t Value);bool HasActivityCount() const;
    ...
    class QuotaFeatureTierDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetPeriod(const std::shared_ptr<QuotaSumByPeriodDto>& Value);bool HasPeriod() const;
            
                /// <summary>
                    /// Determines if activity that reduces the count are counted when determining if an entity is below the limit in the specified Magnopus.Service.Tracking.Dtos.QuotaFeatureTierDto.Period
                    /// (negative value in Magnopus.Service.Tracking.Dtos.QuotaFeatureActivityDto.Amount)
                    /// </summary>
                bool GetAllowReductions() const;
                void SetAllowReductions(const bool& Value);bool HasAllowReductions() const;
    ...
    class QuotaTierAssignmentDto : public csp::services::DtoBase
        ...
        public:
            ...
            void FromJson(const utility::string_t& Json) override;
                ...
                void SetAssignedToType(const utility::string_t& Value);bool HasAssignedToType() const;
            
                /// <summary>
                    /// The id of the entity this tier quota is assigned to (user id, tenant name, etc)
                    /// </summary>
                utility::string_t GetAssignedToId() const;
                void SetAssignedToId(const utility::string_t& Value);bool HasAssignedToId() const;
