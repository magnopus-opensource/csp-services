...
namespace csp::services::generated::trackingservice {
    ...
    QuotaActivityApi::~QuotaActivityApi()
    {
            ...
            void QuotaActivityApi::apiV1UsersUserIdQuotaProgressGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/users/{userId}/quota-progress",
                    {userId}
                );
            ...
            void QuotaActivityApi::apiV1GroupsGroupIdQuotaProgressGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/groups/{groupId}/quota-progress",
                    {groupId}
                );
            ...
            void QuotaActivityApi::apiV1UserUserIdQuotaActivityGet(
                const utility::string_t& userId,const std::optional<std::vector<utility::string_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/user/{userId}/quota-activity",
                    {userId}
                );
            ...
            void QuotaActivityApi::apiV1GroupGroupIdQuotaActivityGet(
                const utility::string_t& groupId,const std::optional<std::vector<utility::string_t>>&
                Features,const std::optional<utility::string_t>&
                StartDateTime,const std::optional<utility::string_t>&
                EndDateTime,const std::optional<int32_t>&
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/group/{groupId}/quota-activity",
                    {groupId}
                );
    ...
    QuotaManagementApi::QuotaManagementApi(csp::web::WebClient* InWebClient) : ApiBase(InWebClient, &csp::CSPFoundation::GetEndpoints().TrackingServiceURI)
    {
    ...
    QuotaManagementApi::~QuotaManagementApi()
    {
            ...
            void QuotaManagementApi::apiV1TiersTierNameQuotasGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/tiers/{tierName}/quotas",
                    {tierName}
                );
            ...
            void QuotaManagementApi::apiV1TiersTierNameFeaturesFeatureNameQuotaGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/tiers/{tierName}/features/{featureName}/quota",
            ...
            void QuotaManagementApi::apiV1TiersTierNameFeaturesFeatureNameQuotaPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void QuotaManagementApi::apiV1TiersTierNameFeaturesFeatureNameQuotaDelete(
                const utility::string_t& tierName,const utility::string_t& featureName,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
    ...
    QuotaTierAssignmentApi::QuotaTierAssignmentApi(csp::web::WebClient* InWebClient) : ApiBase(InWebClient, &csp::CSPFoundation::GetEndpoints().TrackingServiceURI)
    {
    ...
    QuotaTierAssignmentApi::~QuotaTierAssignmentApi()
    {
            ...
            void QuotaTierAssignmentApi::apiV1UsersUserIdTierAssignmentGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/users/{userId}/tier-assignment",
                    {userId}
                );
            ...
            void QuotaTierAssignmentApi::apiV1UsersUserIdTierAssignmentPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void QuotaTierAssignmentApi::apiV1UsersUserIdTierAssignmentDelete(
                const utility::string_t& userId,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void QuotaTierAssignmentApi::apiV1TenantsTenantNameTierAssignmentGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/tenants/{tenantName}/tier-assignment",
                    {tenantName}
                );
            ...
            void QuotaTierAssignmentApi::apiV1TenantsTenantNameTierAssignmentPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void QuotaTierAssignmentApi::apiV1TenantsTenantNameTierAssignmentDelete(
                const utility::string_t& tenantName,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void QuotaTierAssignmentApi::apiV1GroupsTierAssignmentsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/groups/tier-assignments",
                    {}
                );
