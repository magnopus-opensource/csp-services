...
namespace csp::services::generated::aggregationservice
{
    ...
    utility::string_t AloClassCompletedRequest::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value SeriesPlanIdValue(
                        TypeToJsonValue(m_SeriesPlanId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "seriesPlanId",
                        SeriesPlanIdValue,
        ...
        void AloClassCompletedRequest::FromJson(const utility::string_t& Val)
        {
            ...
            }void AloClassCompletedRequest::SetSeriesPlanId(
    ...
    utility::string_t DuplicateSpaceRequest::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value NewGroupOwnerIdValue(
                        TypeToJsonValue(m_NewGroupOwnerId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "newGroupOwnerId",
                        NewGroupOwnerIdValue,
                        JsonDoc.GetAllocator()
                    );
                }
                ...
                {
                    rapidjson::Value MemberGroupIdsValue(
                        TypeToJsonValue(m_MemberGroupIds, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "memberGroupIds",
                        MemberGroupIdsValue,
                ...
                {
                    rapidjson::Value RequestUserIdValue(
                        TypeToJsonValue(m_RequestUserId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "requestUserId",
                        RequestUserIdValue,
                ...
                {
                    rapidjson::Value NewUniqueNameValue(
                        TypeToJsonValue(m_NewUniqueName, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "newUniqueName",
                        NewUniqueNameValue,
                ...
                {
                    rapidjson::Value ShallowCopyValue(
                        TypeToJsonValue(m_ShallowCopy, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "shallowCopy",
                        ShallowCopyValue,
                ...
                {
                    rapidjson::Value AsyncCallValue(
                        TypeToJsonValue(m_AsyncCall, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "asyncCall",
                        AsyncCallValue,
        ...
        void DuplicateSpaceRequest::FromJson(const utility::string_t& Val)
        {
            ...
            }void DuplicateSpaceRequest::SetSpaceId(
                        const utility::string_t& Value
                    )
                {
                        m_SpaceId = Value;
            ...
            }void DuplicateSpaceRequest::SetNewGroupOwnerId(
                        const utility::string_t& Value
                    )
                {
            ...
            const std::vector<utility::string_t>&
                    DuplicateSpaceRequest::GetMemberGroupIds() const
            {
            ...
            }void DuplicateSpaceRequest::SetMemberGroupIds(
                        const std::vector<utility::string_t>& Value
                    )
                {
            ...
            }void DuplicateSpaceRequest::SetNewUniqueName(
                        const utility::string_t& Value
                    )
                {
            ...
            }void DuplicateSpaceRequest::SetRequiresInvite(
                        const bool& Value
                    )
                {
            ...
            }void DuplicateSpaceRequest::SetDiscoverable(
                        const bool& Value
                    )
                {
            ...
            }void DuplicateSpaceRequest::SetShallowCopy(
                        const bool& Value
                    )
                {
                        m_ShallowCopy = Value;
            ...
            }void DuplicateSpaceRequest::SetAsyncCall(
                        const bool& Value
                    )
                {
                        m_AsyncCall = Value;
    ...
    utility::string_t ImportSpaceOptions::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value OverwriteExistingSpaceValue(
                        TypeToJsonValue(m_OverwriteExistingSpace, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "overwriteExistingSpace",
                        OverwriteExistingSpaceValue,
                        JsonDoc.GetAllocator()
                    );
                }
        ...
        void ImportSpaceOptions::FromJson(const utility::string_t& Val)
        {
            ...
            }void ImportSpaceOptions::SetOverwriteExistingSpace(
                        const bool& Value
                    )
                {
            ...
            {
                return m_RequiresInvite.has_value();
            }void ImportSpaceOptions::SetRequiresInvite(
                        const bool& Value
                    )
                {
                        m_RequiresInvite = Value;
            ...
            {
                return m_Discoverable.has_value();
            }void ImportSpaceOptions::SetDiscoverable(
                        const bool& Value
                    )
                {
                        m_Discoverable = Value;
    ...
    utility::string_t ImportSpaceRequest::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value ExportIdValue(
                        TypeToJsonValue(m_ExportId, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "exportId",
                        ExportIdValue,
                ...
                {
                    rapidjson::Value ImportSpaceOptionsValue(
                        TypeToJsonValue(m_ImportSpaceOptions, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "importSpaceOptions",
                        ImportSpaceOptionsValue,
                        JsonDoc.GetAllocator()
                    );
                }
        ...
        void ImportSpaceRequest::FromJson(const utility::string_t& Val)
        {
            ...
            }void ImportSpaceRequest::SetExportId(
                        const utility::string_t& Value
                    )
                {
                        m_ExportId = Value;
            ...
            {
                return m_NewGroupOwnerId.has_value();
            }void ImportSpaceRequest::SetNewGroupOwnerId(
                        const utility::string_t& Value
                    )
                {
                        m_NewGroupOwnerId = Value;
            ...
            const std::vector<utility::string_t>&
                    ImportSpaceRequest::GetMemberGroupIds() const
            {
                    return m_MemberGroupIds.value();
                }
            ...
            {
                return m_MemberGroupIds.has_value();
            }void ImportSpaceRequest::SetMemberGroupIds(
                        const std::vector<utility::string_t>& Value
                    )
                {
                        m_MemberGroupIds = Value;
            ...
            {
                return m_NewUniqueName.has_value();
            }void ImportSpaceRequest::SetNewUniqueName(
                        const utility::string_t& Value
                    )
                {
                        m_NewUniqueName = Value;
            ...
            }void ImportSpaceRequest::SetImportSpaceOptions(
                        const std::shared_ptr<ImportSpaceOptions>& Value
                    )
                {
    ...
    utility::string_t ProblemDetails::ToJson() const
            ...
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                if (m_Detail.has_value())
                {
                    rapidjson::Value DetailValue(
                        TypeToJsonValue(m_Detail, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "detail",
                        DetailValue,
                ...
                if (m_Instance.has_value())
                {
                    rapidjson::Value InstanceValue(
                        TypeToJsonValue(m_Instance, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "instance",
                        InstanceValue,
                ...
                {
                    rapidjson::Value ExtensionsValue(
                        TypeToJsonValue(m_Extensions, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "extensions",
                        ExtensionsValue,
        ...
        void ProblemDetails::FromJson(const utility::string_t& Val)
        {
            ...
            }void ProblemDetails::SetInstance(
                        const utility::string_t& Value
                    )
                {
                        m_Instance = Value;
                    }
            const std::map<utility::string_t, std::shared_ptr<rapidjson::Document>>&
                    ProblemDetails::GetExtensions() const
            {
    ...
    utility::string_t SequenceDto::ToJson() const
        ...
        void SequenceDto::FromJson(const utility::string_t& Val)
        {
            ...
            }void SequenceDto::SetReferenceType(
                        const utility::string_t& Value
                    )
                {
            ...
            }void SequenceDto::SetReferenceId(
                        const utility::string_t& Value
                    )
                {
                        m_ReferenceId = Value;
    ...
    utility::string_t SequenceDtoDataPage::ToJson() const
        ...
        void SequenceDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<SequenceDto>>&
                    SequenceDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            {
                return m_Items.has_value();
            }void SequenceDtoDataPage::SetItems(
                        const std::vector<std::shared_ptr<SequenceDto>>& Value
                    )
                {
                        m_Items = Value;
                    }
    ...
    utility::string_t ShopifyProductVariants::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value QuantityAvailableValue(
                        TypeToJsonValue(m_QuantityAvailable, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "quantityAvailable",
    ...
    utility::string_t ShopifyStorefrontDtoDataPage::ToJson() const
        ...
        void ShopifyStorefrontDtoDataPage::FromJson(const utility::string_t& Val)
        {
            ...
            const std::vector<std::shared_ptr<ShopifyStorefrontDto>>&
                    ShopifyStorefrontDtoDataPage::GetItems() const
            {
                    return m_Items.value();
                }
            ...
            {
                return m_Items.has_value();
            }void ShopifyStorefrontDtoDataPage::SetItems(
                        const std::vector<std::shared_ptr<ShopifyStorefrontDto>>& Value
                    )
                {
                        m_Items = Value;
                    }
    ...
    utility::string_t SliceCompatibility::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value MinimumVersionValue(
                        TypeToJsonValue(m_MinimumVersion, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "minimumVersion",
                        MinimumVersionValue,
        ...
        void SliceCompatibility::FromJson(const utility::string_t& Val)
        {
            ...
            }void SliceCompatibility::SetMinimumVersion(
                        const utility::string_t& Value
                    )
                {
    ...
    utility::string_t SpaceExportDto::ToJson() const
        ...
        void SpaceExportDto::FromJson(const utility::string_t& Val)
        {
            ...
            {
                return m_AsyncCall.has_value();
            }void SpaceExportDto::SetAsyncCall(
                        const bool& Value
                    )
                {
                        m_AsyncCall = Value;
            ...
            {
                return m_RequestUserId.has_value();
            }void SpaceExportDto::SetRequestUserId(
                        const utility::string_t& Value
                    )
                {
    ...
    utility::string_t SpaceImportDto::ToJson() const
        ...
        void SpaceImportDto::FromJson(const utility::string_t& Val)
        {
            ...
            {
                return m_AsyncCall.has_value();
            }void SpaceImportDto::SetAsyncCall(
                        const bool& Value
                    )
                {
                        m_AsyncCall = Value;
    ...
    utility::string_t VersionMatrix::ToJson() const
        {
            rapidjson::Document JsonDoc(rapidjson::kObjectType);
                ...
                {
                    rapidjson::Value ServiceVersionValue(
                        TypeToJsonValue(m_ServiceVersion, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "serviceVersion",
                        ServiceVersionValue,
                ...
                {
                    rapidjson::Value MatrixValue(
                        TypeToJsonValue(m_Matrix, JsonDoc.GetAllocator())
                    );
                    JsonDoc.AddMember(
                        "matrix",
                        MatrixValue,
        ...
        void VersionMatrix::FromJson(const utility::string_t& Val)
        {
            ...
            }void VersionMatrix::SetServiceVersion(
                        const utility::string_t& Value
                    )
                {
                        m_ServiceVersion = Value;
                    }
            const std::map<utility::string_t, std::shared_ptr<SliceCompatibility>>&
                    VersionMatrix::GetMatrix() const
            {
            ...
            }void VersionMatrix::SetMatrix(
                        const std::map<utility::string_t, std::shared_ptr<SliceCompatibility>>& Value
                    )
                {
                        m_Matrix = Value;
                    }
