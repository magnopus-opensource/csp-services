...
namespace csp::services::generated::aggregationservice {
    ...
    SequenceApi::~SequenceApi()
    {
            ...
            void SequenceApi::apiV1SequencesGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SequenceApi::apiV1SequencesPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SequenceApi::apiV1SequencesKeysKeyGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/sequences/keys/{key}",
                    {key}
                );
            ...
            void SequenceApi::apiV1SequencesKeysKeyDelete(
                const utility::string_t& key,csp::services::ApiResponseHandlerBase* ResponseHandler,
    csp::common::CancellationToken& CancellationToken
            ) const
            {
            ...
            void SequenceApi::apiV1SequencesKeysOldKeyKeyPut(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/sequences/keys/{oldKey}/key",
                    {oldKey}
                );
            ...
            void SequenceApi::apiV1SequencesKeysDelete(
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SequenceApi::apiV1SequencesReferenceTypeReferenceTypeReferenceIdReferenceIdDelete(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/sequences/reference-type/{referenceType}/reference-id/{referenceId}",
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ShopifyApi::apiV1SpacesSpaceIdVendorsShopifyProductsVariantsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/spaces/{spaceId}/vendors/shopify/products/variants",
                    {spaceId}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void ShopifyApi::apiV1VendorsShopifyUsersUserIdStorefrontsGet(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/vendors/shopify/users/{userId}/storefronts",
                    {userId}
                );
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SpaceApi::apiV1SpacesDelete(
                const std::optional<std::vector<utility::string_t>>&
    ...
    csp::common::CancellationToken& CancellationToken
            ...
            void SpaceApi::apiV1SpacesSpaceIdDuplicatePost(
    ...
    csp::common::CancellationToken& CancellationToken
            ) const
            {
                csp::web::Uri Uri;
                Uri.SetWithParams(
                    *RootUri + "/api/v1/spaces/{spaceId}/duplicate",
                    {spaceId}
                );
